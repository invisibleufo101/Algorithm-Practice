...
vector<int> getNumbersHorizontal(){
    string n1 = "";
    for (int j=0; j<m; j++){
        n1 += to_string(arr[0][j]);
    }

    string n3 = "";
    for (int j=0; j<m; j++){
        n3 += to_string(arr[n-1][j]);
    }

    int iN1 = atoi(n1.c_str());
    int iN3 = atoi(n3.c_str());
...
vector<int> getNumbersVertical(){
    ...
    string n2 = "";
    for (int i=0; i<n; i++){
        n2 += to_string(arr[i][0]);
    }

    string n4 = "";
    for (int i=0; i<n; i++){
        n4 += to_string(arr[i][m-1]);
    }

    int iN2 = atoi(n2.c_str());
    int iN4 = atoi(n4.c_str());
